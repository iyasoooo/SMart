...
{	
	$SQL_insert = " 
	INSERT INTO `product`(`id_product`, `id_customer`, `product`, `category`, `description`, `price`,  `photo`, `status`) 
	VALUES (NULL, '$id_customer', '$product', '$category', '$description', '$price', '', 'Pending')";		
	...
	//print "<script>self.location='my-product.php';</script>";
}
...
<!--- Toast Notification -->
<?PHP 
if($success) { Notify("success", $success, "my-product.php"); }
?>	
	...
	<div class="w3-container w3-content" style="max-width:600px;">    
	  ...
	  <div class="w3-row ">
		...
		<a onclick="document.getElementById('add01').style.display='block'; " class="w3-margin-bottom w3-right w3-button w3-round-xlarge w3-blue "><i class="fa fa-fw fa-lg fa-plus"></i> Add</a>
		
		<div class="w3-row  ">
		
			<?PHP
			$bil = 0;
			$SQL_list = "SELECT * FROM `product` WHERE `id_customer` = '$id_customer' ";
			...
			<div class="w3-card w3-white w3-padding">
				<div class="w3-center">
				<a target="_blank" href="upload/<?PHP echo $photo; ?>"><img src="upload/<?PHP echo $photo; ?>" class="w3-round-large w3-image" alt="image" style="width:100%;max-width:100px"></a>
				</div>
				<hr style="margin: 5px 0px 5px 0px">				
				<b><?PHP echo $data["product"]; ?></b><br>
				<hr style="margin: 0 0px 5px 0px">
				Category : <?PHP echo $data["category"]; ?><br>
				Price : RM <?PHP echo $data["price"]; ?><br>
				Status : <?PHP echo $data["status"]; ?><br>			
				<hr>				
				<div class="w3-center">
				<a href="#" onclick="document.getElementById('idEdit<?PHP echo $bil;?>').style.display='block'" class="w3-button w3-round-xlarge w3-blue"><i class="fa fa-fw fa-edit fa-lg"></i> Edit</a>				
		...
		<form action="" method="post" enctype="multipart/form-data" >
			...
			<hr>
				...
				<div class="w3-section" >
					...
					<a class="w3-tag w3-red w3-round" href="?act=del_photo&id_product=<?PHP echo $data["id_product"];?>"><small>Remove</small></a>
					
					<?PHP } else { ?><span class="w3-tag w3-round"> <small>None</small></span><?PHP } ?>
					<small>  only JPEG, JPG or PNG allowed </small>
				</div>
