	  ...
	  <div class="w3-row">
		...
		<div class="">
			...
			<div class="w3-card w3-center w3-white w3-padding">
				...
				<hr>							
				<a href="sembang-seller.php?id_customer=<?PHP echo $id_customer;?>&id_seller=<?PHP echo $id_seller;?>" class="w3-button w3-black w3-round-xlarge "><i class="fa fa-fw fa-comment fa-lg"></i>  Reply</a>
