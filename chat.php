...
{	
	...
	print "<script>self.location='chat.php?id_customer=".$id_customer."&id_seller=".$id_seller."&chat=';</script>";
}
...
if($act == "del")
{
	...
	print "<script>self.location='chat.php?id_customer=".$id_customer."&id_seller=".$id_seller."';</script>";
}
?>
<!DOCTYPE html>
<html>
